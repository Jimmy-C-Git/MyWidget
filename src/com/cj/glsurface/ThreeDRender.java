...
public class ThreeDRender implements Renderer {
	...
	public ThreeDRender(Context main) {
		this.context = main;
	...
	public void onDrawFrame(GL10 gl) {
		...
		gl.glLoadIdentity();
		// When using GL_MODELVIEW, you must set the camera view<span
		// style="white-space:pre"></span><pre name="code" class="java"> <span
		// style="font-family: Arial, Helvetica, sans-serif;">GLU.gluLookAt(gl,
		// 0, 0, -5, 0f, 0f, 0f, 0f, 1.0f, 0.0f);</span>
		// 把绘图中心移入屏幕2个单位
